...
@allure.suite('Vopay Iframe')
@allure.title('User back to home page and enter bank manually and cross bank name(Vopay Outer)')
...
#
# @allure.suite('Vopay Iframe')
# @allure.title('User back to home page and enter bank manually and cross bank name(Vopay Inner)')
...
#
# @allure.suite('Vopay Iframe')
# @allure.title('User back to home page and enter bank manually and verify cross button(Vopay JS)')
